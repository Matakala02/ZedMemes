...
if ($result->num_rows > 0) {
    while ($meme = $result->fetch_assoc()) {
        ...
        <div class="bg-white rounded shadow p-3">
          <img src="../' . $img . '" alt="Meme" class="w-full h-auto rounded mb-2">
          ...
          <div class="flex items-center justify-between text-sm">
            ...
            <button class="share-btn text-purple-600" data-link="' . $_SERVER['HTTP_HOST'] . '/' . $img . '">🔗</button>
            <button class="download-btn text-gray-700" data-url="../' . $img . '">⬇️</button>
          </div>
        </div>
        ';
    }
